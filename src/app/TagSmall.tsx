...
export default function TagSmall({ children }: TagSmallProps) {
  return (
    <div className="bg-gray-100/70 px-2 py-1 rounded-md text-xs font-semibold text-gray-600 relative shadow-sm hover:shadow-md transition-shadow duration-150 ease-linear">
      {/* <BorderBeam
        duration={6}
        size={1000}
