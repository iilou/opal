...
const projects: {
...
}[] = [
    {
        ...
        image: "tutormonkey.png",
        link: "https://topaz-gilt.vercel.app",
        tags: [
            "AI",
            "RAG",
            "LLM",
        ...
        github: "https://github.com/iilou/topaz",
    ...
    },
    {
        ...
        tags: ["Next.js", "Tailwind CSS", "TypeScript", "FastAPI", "PostgreSQL", "Docker", "Python", "API Development"],
            ...
            <div className="w-full px-8 flex flex-col items-center bg-transparent gap-4 relative z-10 mb-52">
                <Section>
                    ...
                    <div className="w-52 h-52 relative rounded-full overflow-hidden border-4 border-[#d4d4d4]">
                        <Image src="/IMG_3059.jpg" alt="Profile Picture" fill className="object-cover" />
                    </div>
                    <div className="flex flex-row gap-3">
                        <ButtonLink label="GitHub" href="https://github.com/iilou" />
                        <ButtonLink label="LinkedIn" href="https://www.linkedin.com/in/marvin-li-08953b298/" />
                ...
                <Section>
                    <SectionHeader>
                        ...
                        <SectionSubtitle>A few roles I've held in the past.</SectionSubtitle>
                    </SectionHeader>
                    <div className="w-[90%] w-max-[800px] flex flex-col px-6 py-6 rounded-md bg-[#fafafacf] shadow-sm relative">
                        ...
                        {work_experiences.map((item, index) => (
                            <div key={index} className="flex flex-col w-full">
                                ...
                                <div className="flex flex-row justify-between items-center">
                                    <h5 className="text-sm font-medium text-gray-600">{item.employer}</h5>
                                    <span className="text-sm font-light text-gray-600">{item.location}</span>
                                </div>
                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {projects.map((project, index) => (
                            ...
                            >
                                ...
                                <a href={project.link} target="_blank" rel="noopener noreferrer" className="rounded-md">
                                    <img
                                        src={`/${project.image}`}
                                        alt={`${project.title} screenshot`}
                                        className="w-full object-cover rounded-md mt-4 brightness-75"
                                    />
                                </a>
